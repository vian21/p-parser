...
import {PRIVATE, END, NEXT, PREV, START, VALUE} from '../shared/symbols';

import {prepareMatch} from '../shared/matches';
import {previousSibling, nextSibling} from '../shared/node';
import {getEnd, knownAdjacent, knownBoundaries, knownSegment, knownSiblings, localCase} from '../shared/utils';

import {Node} from '../interface/node';
import {Text} from '../interface/text';
import {NodeList} from '../interface/node-list';

import {moCallback} from '../interface/mutation-observer';
import {connectedCallback} from '../interface/custom-element-registry';

import {nextElementSibling} from './non-document-type-child-node';
...
/** @typedef { import('../interface/element').Element & {
