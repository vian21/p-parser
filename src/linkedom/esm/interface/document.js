...
import {DOCUMENT_NODE, DOCUMENT_FRAGMENT_NODE, DOCUMENT_TYPE_NODE, ELEMENT_NODE, SVG_NAMESPACE} from '../shared/constants';
...
import {Facades, illegalConstructor} from '../shared/facades';
import {HTMLClasses} from '../shared/html-classes';
import {Mime} from '../shared/mime';
import {knownSiblings} from '../shared/utils';
import {assign, create, defineProperties, setPrototypeOf} from '../shared/object';
...
import {MutationObserverClass} from './mutation-observer';
