...
import {elementAsJSON} from '../shared/jsdon';
import {matches, prepareMatch} from '../shared/matches';
import {shadowRoots} from '../shared/shadow-roots';

import {isConnected, parentElement, previousSibling, nextSibling} from '../shared/node';
import {previousElementSibling, nextElementSibling} from '../mixin/non-document-type-child-node';

import {before, after, replaceWith, remove} from '../mixin/child-node';
import {getInnerHtml, setInnerHtml} from '../mixin/inner-html';
import {ParentNode} from '../mixin/parent-node';
