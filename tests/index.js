...
console.log(
  assert(document.querySelectorAll("span").length === 1),
  "Test querySelectorAll() on unique element"
);
console.log(
  assert(document.querySelectorAll("p")[0].textContent === "Hello World"),
  "Test querySelectorAll() on multiple elements"
);
